...
struct __smc_cs {
	uint32_t setup;		/* SMC Setup Register */
	uint32_t pulse;		/* SMC Pulse Register */
	uint32_t cycle;		/* SMC Cycle Register */
	uint32_t mode;		/* SMC MODE Register */
};
